...
function Instructor() {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!register.fullName) {
      setErrors({ ...errors, fullName: "Please enter your fullName ." });
      return;
    }
              ...
              <div className="flex flex-col mb-6">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400">
                    <svg
                      className="h-6 w-6 inline-block mr-2 text-gray-400"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d="M12 2C7.032 2 3 6.038 3 10v2a5 5 0 0 0 5 5h8a5 5 0 0 0 5-5v-2c0-3.962-4.032-8-9-8z"
                      />
